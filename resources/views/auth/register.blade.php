        ...
        <div class="register-box-body">
            ...
            {!! Form::open(['method'=>'POST','route'=>'register']) !!}
                ...
                <div class="form-group has-feedback @error('phone') has-error @enderror">
                    {!! Form::tel('phone', null, array('placeholder' => 'Phone number (Eg :04XXXXXXXX)','class' => 'form-control','required'=>'true')) !!}
                    <span class="help-block">Enter your current australian phone number </span>
